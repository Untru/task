...
Процедура УстановитьОграниченияВыбираемыхТиповИПараметрыВыбора(Элемент)
	...
	Если МассивТипов.Найти(Тип("Число")) = Неопределено Тогда
		КЧ = Неопределено;
	Иначе
		КЧ = Новый КвалификаторыЧисла(17,6);
	КонецЕсли;
	
	Поле.ОграничениеТипа = Новый ОписаниеТипов(МассивТипов,,, КЧ);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекущийПользователь = ПараметрыСеанса.ТекущийПользователь;//.АвторизованныйПользователь();
...
Процедура ЗаполнитьДеревоОбъектовИОпераций()
	...
	ВведенныеОперации.Колонки.Добавить("Свойство",    Новый ОписаниеТипов("Строка"));
